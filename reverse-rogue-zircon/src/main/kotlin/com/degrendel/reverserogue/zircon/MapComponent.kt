...
// TODO: Kinda feels like maybe this should immutably wrapped around a level
class MapComponent(private val app: Application, private val layer: Layer)
{
  ...
  fun newLevel()
  {
    val level = app.world.generateLevel()
